...
namespace {
	 ...
	 * @method void setUseSingleProperty(bool $value)
	 * @method string getSinglePropertyName()
	 * @method void setSinglePropertyName(\string $value)
	 * @method bool getUseWakeupAndSleep()
	 * @method void setUseWakeupAndSleep(bool $value)
		...
		public static function getDescriptor()
		{
			...
			if (!isset($descriptor)) {
				...
				$desc->addField(8001, new \ProtocolBuffers\FieldDescriptor(array(
					...
					"repeated" => false,
					"packable" => false,
					"default"  => "\\ProtocolBuffers\\Message",
				)));
